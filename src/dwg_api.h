...
double
dwg_ent_dim_ordinate_get_elevation_ecs11(const dwg_ent_dim_ordinate *dim,
                                         int *error);
...
double
dwg_ent_dim_ordinate_get_elevation_ecs12(const dwg_ent_dim_ordinate *dim,
                                         int *error);
...
double
dwg_ent_dim_ordinate_get_act_measurement(const dwg_ent_dim_ordinate *dim,
                                         int *error);
...
unsigned int
dwg_ent_dim_ordinate_get_lspace_style(const dwg_ent_dim_ordinate *dim, int *error);
...
void
dwg_ent_dim_ordinate_get_10_pt(const dwg_ent_dim_ordinate *ord, dwg_point_3d *point,
                               int *error);
...
void
dwg_ent_dim_ordinate_get_13_pt(const dwg_ent_dim_ordinate *ord, dwg_point_3d *point,
                               int *error);
...
void
dwg_ent_dim_ordinate_get_14_pt(const dwg_ent_dim_ordinate *ord, dwg_point_3d *point,
                               int *error);
...
char
dwg_ent_dim_ordinate_get_flags2(const dwg_ent_dim_ordinate *ord, int *error);
...
double
dwg_ent_dim_linear_get_lspace_factor(const dwg_ent_dim_linear *dim, int *error);
...
double
dwg_ent_dim_ang2ln_get_act_measurement(const dwg_ent_dim_ang2ln *ang, int *error);
...
double
dwg_ent_dim_ang2ln_get_horiz_dir(const dwg_ent_dim_ang2ln *ang, int *error);
...
double
dwg_ent_dim_ang2ln_get_lspace_factor(const dwg_ent_dim_ang2ln *ang, int *error);
...
unsigned int
dwg_ent_dim_radius_get_attachment_point(const dwg_ent_dim_radius *radius,
                                        int *error);
...
double
dwg_ent_dim_diameter_get_elevation_ecs11(const dwg_ent_dim_diameter *dia,
                                         int *error);
...
double
dwg_ent_dim_diameter_get_elevation_ecs12(const dwg_ent_dim_diameter *dia,
                                         int *error);
...
double
dwg_ent_dim_diameter_get_act_measurement(const dwg_ent_dim_diameter *dia,
                                         int *error);
...
unsigned int
dwg_ent_table_get_title_vert_right_lineweight(const dwg_ent_table *table,
                                              int *error);
...
unsigned int
dwg_ent_table_get_header_horiz_ins_lineweight(const dwg_ent_table *table, int *error);
...
unsigned int
dwg_ent_table_get_header_vert_left_lineweight(const dwg_ent_table *table,
                                              int *error);
...
unsigned int
dwg_ent_table_get_data_vert_left_lineweight(const dwg_ent_table *table, int *error);
...
unsigned int
dwg_ent_table_get_data_vert_right_lineweight(const dwg_ent_table *table, int *error);
